...
const NowPlaying = () => {
  ...
  const url1 = "https://api.themoviedb.org/3/trending/all/day?api_key=9f7d1552ee8bc764968cc66c5acf4915";
  ...
  <input type="text"  value={search}
              onChange={handleInput} class="form-control" placeholder="Search" />
</div>
          </div>
        </div>
                ...
                <div  className="row card-playing" key={index}>
                  <div className="card-img-playing">
                    ...
                    />
                      ...
                      <div classsName="card-title-playing" style={{width:"70%"}}>
                      
                        <Link to={`/details/${el.id}`}>{el.title}</Link>
                      </div>
                      <div className="card-rating-playing" style={{width:"30%"}}>
                         {el.vote_average}
                      </div>
                    </div>
                  </div>  
